...
export function JobPreferencesStep({ preferences, onChange }: JobPreferencesStepProps) {
  ...
  return (
    <div className="min-h-[60vh] rounded-2xl bg-gradient-to-b from-white via-white to-[var(--brand-muted)]/30 px-4 py-8 sm:p-8">
      <div className="mx-auto max-w-2xl">
        <div className="overflow-hidden rounded-2xl border border-[var(--border)] bg-white shadow-lg">
          <div className="p-8 sm:p-10">
            <div className="flex flex-col items-center text-center">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[var(--brand)] text-white">
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <select
                  ...
                  className="flex h-9 w-full max-w-[280px] rounded-[var(--radius)] border border-[var(--border)] bg-[var(--input-background)] px-3 py-2 text-sm text-[var(--foreground)]"
                >
